...
ln -sf "$MODPATH/system/bin/sys.azenith-service" "/system/bin/sys.azenith-service_log"
ln -sf "$MODPATH/system/bin/sys.azenith-service" "/system/bin/sys.azenith-profiler"
rm -rf "$TMPDIR/libs"
